...
#define copyref(self, k, other, k2, n) { \
        int _i, _cur, _stop = (k)+(n); \
        for ( _i = (k), _cur = (k2); _i < _stop; _i++) { \
                (self)->children[_i] = (other)->children[_cur++]; \
                Py_INCREF((self)->children[_i]); \
        } \
}
...
{
        int mask;
        PyBList *power, *rv, *remainder = NULL;
        int remainder_n = 0;
